...
PySpark: For distributed data processing and analysis of large datasets
Python: For writing the data processing scripts
Jupyter Notebook: Used as the development environment for running and testing PySpark code
